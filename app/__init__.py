...
#app.config['SQLALCHEMY_DATABASE_URI'] = f"mysql://{os.getenv('DB_USERNAME')}:{os.getenv('DB_PASSWORD')}@{os.getenv('DB_HOST')}:{os.getenv('DB_PORT', '25742')}/{os.getenv('DB_NAME')}"
#app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://avnadmin:AVNS_pwTWMvT0F3ic2qM7wX0@mysql-1d95116b-dxaldovah-278d.a.aivencloud.com:25742/defaultdb'
